...
if (node.nodeType === 3) {
    ...
    replacedText = replacedText.replace(/donald j.? trump/gi, 'Presidential Candidate and human garbage-fire, Donald J. Trump');
    replacedText = replacedText.replace(/donald john trump/gi, 'Presidential Candidate and human dumpster-fire, Donald John Trump');
